...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		// Inicio del backup de reserva a null
		ReservaController.reservaBackup = null;
	    ...
	    DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd-MM-YYYY"); // Formateo de fecha
	    labelFecha.setText("Hoy es " + fechaHoy.format(formatter)); //setear la representacion en cadena de la fecha
