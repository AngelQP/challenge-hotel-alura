...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Angel Quispe © 2023");
		...
		btnexit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				int answer = JOptionPane.showConfirmDialog(null, "¿Deseas salir de la aplicación?", "Pregunta", JOptionPane.YES_NO_OPTION);
