...
public class Login extends JFrame {
	...
	public Login() {
		...
		// cursorHand tipo hand
		var cursorHand = new Cursor(Cursor.HAND_CURSOR);
		...
		btnLogin.addMouseListener(new MouseAdapter() {
			...
			// Aqui sirve para pasar a la siguiente ventana
			@Override
			public void mouseClicked(MouseEvent e) {
				register();
			}
	...
	// Para mover la ventana si se presiona la parte superior del programa
