...
public class ReservasView extends JFrame {
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if(txtFechaSalida.getDate() != null && txtFechaEntrada.getDate() != null) {		
					...
					LocalDate fechaIn = formatDateToLocalDate(txtFechaEntrada.getDate());
					LocalDate fechaOut = formatDateToLocalDate(txtFechaSalida.getDate());
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {	
					...
					ReservaController.reservaBackup =  new Reserva(fechaIn, fechaOut, valor, formaPago);
					
					reservaController.guardar(ReservaController.reservaBackup);
					
					// TODO: Crear un objeto de Reserva y consulta a la base de datos el número de reserva
    ...
    private boolean confirmDate(Date fechaIn, Date fechaOut) {
    	...
    	LocalDate fechaEntrada = formatDateToLocalDate(fechaIn);
    	LocalDate fechaSalida = formatDateToLocalDate(fechaOut);
    ...
    private Date formatLocalDateToDate(LocalDate fecha) {
    ...
    private void recuperarBackup() {
    	...
    	if(ReservaController.reservaBackup == null) {
    		return;
    	}
    	
    	Reserva reserva = ReservaController.reservaBackup;
    	
    	// Restauración de fechas
    	Date dateIn = formatLocalDateToDate(reserva.getFechaEntrada());
    	Date dateOut = formatLocalDateToDate(reserva.getFechaSalida());
